...
export default function Nav(params) {
    ...
    const logo = brand!.logo ? <img src={`${directus.url}assets/${brand?.logo?.filename_disk}`} className="h-8 w-auto" alt={brand.name} /> : null
    //<img src={`${directus.url}assets/${brand?.logo?.filename_disk}`} className="h-8 w-auto" alt={brand.name} />
